"""
Django settings for Sayyid181087 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-=@_f9m6c+^uirdgswc7b%g4@ws*y(wxk4c-1#5x$kkn!nir$@e')
...
ROOT_URLCONF = 'Sayyid181087.urls'
...
WSGI_APPLICATION = 'Sayyid181087.wsgi.application'
